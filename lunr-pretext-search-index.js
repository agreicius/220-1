...
},
{
  ...
  "number": "3.6",
  "title": "Sandwich theorem.",
  "body": " Sandwich theorem   To compute using the sandwich theorem, proceed as follows.   Find bounding functions and satisfying the two following conditions:    for all lying in an open interval containing .     for some .       Conclude (citing the sandwich theorem) that       "
},
{
  "id": "ss_sandwich-7",
  "level": "2",
  "url": "s_limit_sandwich.html#ss_sandwich-7",
  "type": "Example",
  "number": "3.7",
  "title": "Sandwich theorem: easy.",
  "body": " Sandwich theorem: easy   Suppose the function satisfies for all in the interval . Compute .       "
},
{
  "id": "ss_sandwich-8",
  "level": "2",
  ...
  "type": "Example",
  "number": "3.8",
  "title": "Sandwich theorem: harder.",
  "body": " Sandwich theorem: harder   Use the sandwich theorem to compute .       "
},
{
