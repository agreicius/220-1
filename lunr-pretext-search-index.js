...
},
{
  ...
  "body": " Inequality rules   Let be a nonnegative number; , . For all we have . It follows that for all nonnegative , we have .   "
},
{
  "id": "s_one_sided",
  "level": "1",
