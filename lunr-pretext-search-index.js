...
},
{
  ...
  "number": "13.4",
  "title": "Drone.",
  "body": " Drone   Dudley gets his hands on the remote control for a drone and pilots it for a glorious 3 seconds. Luckily, the drone can only move directly up and down. The altitude (in meters) of the drone seconds after Dudley takes control is given as .   Derive formulas for the velocity , speed , and acceleration of the drone seconds after Dudley takes control.    Find the time intervals when the drone is ascending, and the time intervals when it is descending.    Describe the end of Dudley's flight at time seconds. Where is the drone? Did a fatal crash happen?    Compute (a) the displacement of the drone over the time interval , and (b) the total distance traveled.          "
},
{
  "id": "d_marginals",
  "level": "2",
